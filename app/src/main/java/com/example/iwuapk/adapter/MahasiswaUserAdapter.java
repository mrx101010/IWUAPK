...
public class MahasiswaUserAdapter extends RecyclerView.Adapter<MahasiswaUserAdapter.MyViewHolder> {

    private ArrayList<Mahasiswa> mahasiswaArrayList;

    public MahasiswaUserAdapter(ArrayList<Mahasiswa> mahasiswaArrayList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_mahasiswa_user, parent, false);
