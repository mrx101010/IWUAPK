...
//                Function
        ...
        String id = intent.getStringExtra(DosenUserAdapter.DOSEN_IDD);
        String name = intent.getStringExtra(DosenUserAdapter.DOSEN_NAMEE);
...
//        final AlertDialog.Builder dialog = new AlertDialog.Builder(MahasiswaUserActivity.this);
...
//                    Toast.makeText(MahasiswaUserActivity.this, "Masukan Nama Anda", Toast.LENGTH_SHORT).show();
//                    return;
//                }
//
//                if (TextUtils.isEmpty(edtAsal.getText().toString())) {
//                    Toast.makeText(MahasiswaUserActivity.this, "Masukan Asal Sekolah Anda", Toast.LENGTH_SHORT).show();
//                    return;
//                }
//
//                if (TextUtils.isEmpty(spinnerProdi.getSelectedItem().toString())) {
//                    Toast.makeText(MahasiswaUserActivity.this, "Pilih Prodi Anda", Toast.LENGTH_SHORT).show();
//                    return;
//                }
//
...
//
//                Toast.makeText(MahasiswaUserActivity.this, "Data berhasil dimasukan", Toast.LENGTH_SHORT).show();
//            }
//        });
//
//        dialog.show();
